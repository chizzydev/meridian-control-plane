...
import {
  ...
  postO02ProcessResume,
  readO02Process,
} from "./process-resume-action-transport";

describe(
  "O02 process resume transport",
  () => {
    it(
    ...
    it(
      "dispatches exactly one bodyless POST /v2/process/resume?id=<pid>",
      async () => {
        const calls:
          Array<{
            url:
        ...
        expect(
          ...
          {
            url:
              "http://iris.example/api/admin/v2/process/resume?id=4242",
            method:
              "POST",
            body:
              undefined,
