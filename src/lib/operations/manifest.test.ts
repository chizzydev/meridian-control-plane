...
describe(
  ...
  () => {
    ...
    it(
      "binds all 32 required release actions and freezes the R5-F2 candidate promotion for P01, P02, P03, P04, P05, P06, T01, T02, T03, T04, T05, T06, and W01 through W04",
      () => {
        const ids =
          sysAdminOperationManifest
            .mutationRegistry
