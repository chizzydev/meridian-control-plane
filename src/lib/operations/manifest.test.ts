...
describe(
  ...
  () => {
    ...
    it(
      "binds all 32 required release actions and freezes the R6-O01 candidate promotion for P01, P02, P03, P04, P05, P06, T01, T02, T03, T04, T05, T06, O01, and W01 through W04",
      () => {
        const ids =
          sysAdminOperationManifest
            .mutationRegistry
